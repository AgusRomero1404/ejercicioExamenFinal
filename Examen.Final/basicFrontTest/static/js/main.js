...
//constante de articulos en la base de datos
const articles = data => {
    for(let i of data){
            ...
            <div class=" "  >
                <div class="card"  data-id="${ i.id }" >
                    <div class="card-body">
                        ...
                        <p class="card-text">Descripcion:${ i.description }</p>
                        <div class="action">
...
function edit(e){
    ...
    if(name === '' || total === '' || description === ''){
        ...
        try{
            var payload = { name, total , description, id}
            ...
            .then((dataJson) => {
                if( dataJson.id ){
                    ...
                    dom[2].innerHTML = dataJson.description
                }else{
...
function cerrarSesion() {
    ...
    if (sessionStorage.getItem("sess", false)){
        location.replace("./login/index.html")
    }
};  
